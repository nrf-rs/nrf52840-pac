...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BURSTR {# [ doc = "Burst mode is disabled (normal operation)" ] DISABLED , # [ doc = "Burst mode is enabled. SAADC takes 2^OVERSAMPLE number of samples as fast as it can, and sends the average to Data RAM." ] ENABLED ,}
impl BURSTR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
pub enum BURSTW {# [ doc = "Burst mode is disabled (normal operation)" ] DISABLED , # [ doc = "Burst mode is enabled. SAADC takes 2^OVERSAMPLE number of samples as fast as it can, and sends the average to Data RAM." ] ENABLED ,}
impl BURSTW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _BURSTW<'a> {
    ...
    # [ doc = "Burst mode is enabled. SAADC takes 2^OVERSAMPLE number of samples as fast as it can, and sends the average to Data RAM." ] # [ inline ]
