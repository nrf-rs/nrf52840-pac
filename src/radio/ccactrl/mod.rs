...
pub enum CCAMODER {# [ doc = "Energy Above Threshold" ] EDMODE , # [ doc = "Carrier Seen" ] CARRIERMODE , # [ doc = "Energy Above Threshold AND Carrier Seen" ] CARRIERANDEDMODE , # [ doc = "Energy Above Threshold OR Carrier Seen" ] CARRIEROREDMODE , # [ doc = "Energy Above Threshold test mode that will abort when first ED measurement over threshold is seen. No averaging." ] EDMODETEST1 , # [ doc = r" Reserved" ] _Reserved ( u8 ) ,}
impl CCAMODER {
...
pub enum CCAMODEW {# [ doc = "Energy Above Threshold" ] EDMODE , # [ doc = "Carrier Seen" ] CARRIERMODE , # [ doc = "Energy Above Threshold AND Carrier Seen" ] CARRIERANDEDMODE , # [ doc = "Energy Above Threshold OR Carrier Seen" ] CARRIEROREDMODE , # [ doc = "Energy Above Threshold test mode that will abort when first ED measurement over threshold is seen. No averaging." ] EDMODETEST1 ,}
impl CCAMODEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _CCAMODEW<'a> {
    ...
    # [ doc = "Energy Above Threshold test mode that will abort when first ED measurement over threshold is seen. No averaging." ] # [ inline ]
...
impl R {
    ...
    # [ doc = "Bits 16:23 - CCA Correlator Busy Threshold. Only relevant to CarrierMode, CarrierAndEdMode and CarrierOrEdMode." ] # [ inline ]
    ...
    # [ doc = "Bits 24:31 - Limit for occurances above CCACORRTHRES. When not equal to zero the corrolator based signal detect is enabled." ] # [ inline ]
