...
impl<'a> _TXPOWERW<'a> {
    ...
    pub fn pos8d_bm(self) -> &'a mut W {
        self.variant(TXPOWERW::POS8DBM)
    }
    #[doc = "+7 dBm"]
    #[inline]
    pub fn pos7d_bm(self) -> &'a mut W {
        self.variant(TXPOWERW::POS7DBM)
    }
    #[doc = "+6 dBm"]
    #[inline]
    pub fn pos6d_bm(self) -> &'a mut W {
        self.variant(TXPOWERW::POS6DBM)
    }
    #[doc = "+5 dBm"]
    #[inline]
    pub fn pos5d_bm(self) -> &'a mut W {
        self.variant(TXPOWERW::POS5DBM)
    }
    #[doc = "+4 dBm"]
    #[inline]
