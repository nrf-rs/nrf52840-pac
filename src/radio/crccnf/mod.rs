...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SKIPADDRR {# [ doc = "CRC calculation includes address field" ] INCLUDE , # [ doc = "CRC calculation does not include address field. The CRC calculation will start at the first byte after the address." ] SKIP , # [ doc = "CRC calculation as per 802.15.4 standard. Starting at first byte after length field." ] IEEE802154 , # [ doc = r" Reserved" ] _Reserved ( u8 ) ,}
impl SKIPADDRR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
...
pub enum SKIPADDRW {# [ doc = "CRC calculation includes address field" ] INCLUDE , # [ doc = "CRC calculation does not include address field. The CRC calculation will start at the first byte after the address." ] SKIP , # [ doc = "CRC calculation as per 802.15.4 standard. Starting at first byte after length field." ] IEEE802154 ,}
impl SKIPADDRW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _SKIPADDRW<'a> {
    ...
    # [ doc = "CRC calculation does not include address field. The CRC calculation will start at the first byte after the address." ] # [ inline ]
