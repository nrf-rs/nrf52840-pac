...
impl R {
    ...
    # [ doc = "Bit 8 - Signals that the USB lines have been seen idle long enough for the device to enter suspend. Write '1' to clear." ] # [ inline ]
    ...
    # [ doc = "Bit 9 - Signals that a RESUME condition (K state or activity restart) has been detected on the USB lines. Write '1' to clear." ] # [ inline ]
    ...
    # [ doc = "Bit 11 - Wrapper has re-initialized SFRs to the proper values. MAC is ready for normal operation. Write '1' to clear." ] # [ inline ]
