...
pub enum STATER {# [ doc = "D+ forced low, D- forced high (K state) for a timing pre-set in hardware (50 us or 5 ms, depending on bus state)" ] RESUME , # [ doc = "D+ forced high, D- forced low (J state)" ] J , # [ doc = "D+ forced low, D- forced high (K state)" ] K , # [ doc = r" Reserved" ] _Reserved ( u8 ) ,}
impl STATER {
...
pub enum STATEW {# [ doc = "D+ forced low, D- forced high (K state) for a timing pre-set in hardware (50 us or 5 ms, depending on bus state)" ] RESUME , # [ doc = "D+ forced high, D- forced low (J state)" ] J , # [ doc = "D+ forced low, D- forced high (K state)" ] K ,}
impl STATEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _STATEW<'a> {
    ...
    # [ doc = "D+ forced low, D- forced high (K state) for a timing pre-set in hardware (50 us or 5 ms, depending on bus state)" ] # [ inline ]
