#[doc = "Reader of register SDA"]
pub type R = crate::R<u32, super::SDA>;
#[doc = "Writer for register SDA"]
pub type W = crate::W<u32, super::SDA>;
#[doc = "Register SDA `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::SDA {
    type Type = u32;
    #[inline(always)]
