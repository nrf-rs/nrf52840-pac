...
pub struct RegisterBlock {
    #[doc = "0x00 - Description collection\\[n\\]: Trigger n for triggering the corresponding TRIGGERED\\[n\\]
event"]
    pub tasks_trigger: [TASKS_TRIGGER; 16],
    _reserved1: [u8; 192usize],
    #[doc = "0x100 - Description collection\\[n\\]: Event number n generated by triggering the corresponding TRIGGER\\[n\\]
task"]
