...
impl<'a> _PREGION0WAW<'a> {
    ...
    #[inline]
    pub fn clear(self) -> &'a mut W {
        self.variant(PREGION0WAW::CLEAR)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _PREGION0RAW<'a> {
    ...
    #[inline]
    pub fn clear(self) -> &'a mut W {
        self.variant(PREGION0RAW::CLEAR)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _PREGION1WAW<'a> {
    ...
    #[inline]
    pub fn clear(self) -> &'a mut W {
        self.variant(PREGION1WAW::CLEAR)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _PREGION1RAW<'a> {
    ...
    #[inline]
    pub fn clear(self) -> &'a mut W {
        self.variant(PREGION1RAW::CLEAR)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
