...
#[doc = r" Register block"]
#[repr(C)]
pub struct PERREGION { # [ doc = "0x00 - Description cluster[0]: Source of event/interrupt in region 0, write access detected while corresponding subregion was enabled for watching" ] pub substatwa : self :: perregion :: SUBSTATWA , # [ doc = "0x04 - Description cluster[0]: Source of event/interrupt in region 0, read access detected while corresponding subregion was enabled for watching" ] pub substatra : self :: perregion :: SUBSTATRA }
#[doc = r" Register block"]
#[doc = "Unspecified"]
pub mod perregion;
#[doc = r" Register block"]
