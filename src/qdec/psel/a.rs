#[doc = "Reader of register A"]
pub type R = crate::R<u32, super::A>;
#[doc = "Writer for register A"]
pub type W = crate::W<u32, super::A>;
#[doc = "Register A `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::A {
    type Type = u32;
    #[inline(always)]
