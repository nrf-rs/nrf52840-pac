#[doc = "Reader of register B"]
pub type R = crate::R<u32, super::B>;
#[doc = "Writer for register B"]
pub type W = crate::W<u32, super::B>;
#[doc = "Register B `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::B {
    type Type = u32;
    #[inline(always)]
