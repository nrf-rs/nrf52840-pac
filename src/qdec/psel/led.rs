#[doc = "Reader of register LED"]
pub type R = crate::R<u32, super::LED>;
#[doc = "Writer for register LED"]
pub type W = crate::W<u32, super::LED>;
#[doc = "Register LED `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::LED {
    type Type = u32;
    #[inline(always)]
