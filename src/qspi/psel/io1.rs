#[doc = "Reader of register IO1"]
pub type R = crate::R<u32, super::IO1>;
#[doc = "Writer for register IO1"]
pub type W = crate::W<u32, super::IO1>;
#[doc = "Register IO1 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::IO1 {
    type Type = u32;
    #[inline(always)]
