#[doc = "Reader of register IO2"]
pub type R = crate::R<u32, super::IO2>;
#[doc = "Writer for register IO2"]
pub type W = crate::W<u32, super::IO2>;
#[doc = "Register IO2 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::IO2 {
    type Type = u32;
    #[inline(always)]
