#[doc = "Reader of register IO0"]
pub type R = crate::R<u32, super::IO0>;
#[doc = "Writer for register IO0"]
pub type W = crate::W<u32, super::IO0>;
#[doc = "Register IO0 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::IO0 {
    type Type = u32;
    #[inline(always)]
