#[doc = "Reader of register IO3"]
pub type R = crate::R<u32, super::IO3>;
#[doc = "Writer for register IO3"]
pub type W = crate::W<u32, super::IO3>;
#[doc = "Register IO3 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::IO3 {
    type Type = u32;
    #[inline(always)]
