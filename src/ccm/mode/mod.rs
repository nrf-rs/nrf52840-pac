...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LENGTHR {# [ doc = "Default length. Effective length of LENGTH field in encrypted/decrypted packet is 5 bits. A key-stream for packets up to 27 bytes will be generated." ] DEFAULT , # [ doc = "Extended length. Effective length of LENGTH field in encrypted/decrypted packet is 8 bits. A key-stream for packets up to MAXPACKETSIZE bytes will be generated." ] EXTENDED ,}
impl LENGTHR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
pub enum LENGTHW {# [ doc = "Default length. Effective length of LENGTH field in encrypted/decrypted packet is 5 bits. A key-stream for packets up to 27 bytes will be generated." ] DEFAULT , # [ doc = "Extended length. Effective length of LENGTH field in encrypted/decrypted packet is 8 bits. A key-stream for packets up to MAXPACKETSIZE bytes will be generated." ] EXTENDED ,}
impl LENGTHW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _LENGTHW<'a> {
    ...
    # [ doc = "Default length. Effective length of LENGTH field in encrypted/decrypted packet is 5 bits. A key-stream for packets up to 27 bytes will be generated." ] # [ inline ]
    pub fn default(self) -> &'a mut W {
        self.variant(LENGTHW::DEFAULT)
    }
    # [ doc = "Extended length. Effective length of LENGTH field in encrypted/decrypted packet is 8 bits. A key-stream for packets up to MAXPACKETSIZE bytes will be generated." ] # [ inline ]
...
impl R {
    ...
    # [ doc = "Bit 0 - The mode of operation to be used. The settings in this register apply whenever either the KSGEN or CRYPT tasks are triggered." ] # [ inline ]
