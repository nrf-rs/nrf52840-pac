...
#[no_mangle]
#[used]
pub static INTERRUPTS: [Option<unsafe extern "C" fn()>; 46] = [
    Some(POWER_CLOCK),
    Some(RADIO),
    Some(UARTE0_UART0),
...
impl TryFrom<u8> for Interrupt {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            2 => Ok(Interrupt::UARTE0_UART0),
            3 => Ok(Interrupt::SPIM0_SPIS0_TWIM0_TWIS0_SPI0_TWI0),
            4 => Ok(Interrupt::SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1),
            5 => Ok(Interrupt::NFCT),
            6 => Ok(Interrupt::GPIOTE),
            7 => Ok(Interrupt::SAADC),
            ...
            19 => Ok(Interrupt::COMP_LPCOMP),
            20 => Ok(Interrupt::SWI0_EGU0),
            21 => Ok(Interrupt::SWI1_EGU1),
            22 => Ok(Interrupt::SWI2_EGU2),
            23 => Ok(Interrupt::SWI3_EGU3),
            24 => Ok(Interrupt::SWI4_EGU4),
            25 => Ok(Interrupt::SWI5_EGU5),
            26 => Ok(Interrupt::TIMER3),
            27 => Ok(Interrupt::TIMER4),
            28 => Ok(Interrupt::PWM0),
            29 => Ok(Interrupt::PDM),
            32 => Ok(Interrupt::MWU),
            33 => Ok(Interrupt::PWM1),
            34 => Ok(Interrupt::PWM2),
            35 => Ok(Interrupt::SPIM2_SPIS2_SPI2),
            36 => Ok(Interrupt::RTC2),
            37 => Ok(Interrupt::I2S),
            38 => Ok(Interrupt::FPU),
            39 => Ok(Interrupt::USBD),
            40 => Ok(Interrupt::UARTE1),
            41 => Ok(Interrupt::QSPI),
            42 => Ok(Interrupt::CRYPTOCELL),
            43 => Ok(Interrupt::SPIM3),
            45 => Ok(Interrupt::PWM3),
