# ! [ cfg_attr ( feature = "rt" , feature ( global_asm ) ) ] # ! [ cfg_attr ( feature = "rt" , feature ( macro_reexport ) ) ] # ! [ cfg_attr ( feature = "rt" , feature ( used ) ) ] # ! [ doc = "Peripheral access API for NRF52840 microcontrollers (generated using svd2rust v0.12.0)\n\nYou can find an overview of the API [here].\n\n[here]: https://docs.rs/svd2rust/0.12.0/svd2rust/#peripheral-api" ] # ! [ allow ( private_no_mangle_statics ) ] # ! [ deny ( missing_docs ) ] # ! [ deny ( warnings ) ] # ! [ allow ( non_camel_case_types ) ] # ! [ feature ( const_fn ) ] # ! [ feature ( try_from ) ] # ! [ no_std ]
...
impl ACL {
    #[doc = r" Returns a pointer to the register block"]
    pub fn ptr() -> *const acl::RegisterBlock {
        1073864704 as *const _
    }
}
impl Deref for ACL {
    type Target = acl::RegisterBlock;
    fn deref(&self) -> &acl::RegisterBlock {
        unsafe { &*ACL::ptr() }
    }
}
#[doc = "Access control lists"]
...
impl USBD {
    #[doc = r" Returns a pointer to the register block"]
    pub fn ptr() -> *const usbd::RegisterBlock {
        1073901568 as *const _
    }
}
impl Deref for USBD {
    type Target = usbd::RegisterBlock;
    fn deref(&self) -> &usbd::RegisterBlock {
        unsafe { &*USBD::ptr() }
    }
}
#[doc = "Universal Serial Bus device"]
...
#[doc = "ARM CryptoCell register interface"]
