...
pub struct RegisterBlock {
    ...
    #[doc = "0x40 - Description collection\\[n\\]: Capture Timer value to CC\\[n\\]
register"]
    pub tasks_capture: [TASKS_CAPTURE; 4],
    _reserved6: [u8; 240usize],
    #[doc = "0x140 - Description collection\\[n\\]: Compare event on CC\\[n\\]
match"]
    ...
    #[doc = "0x540 - Description collection\\[n\\]: Capture/Compare register n"]
    pub cc: [CC; 4],
}
