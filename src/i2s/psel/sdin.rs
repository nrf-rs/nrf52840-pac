#[doc = "Reader of register SDIN"]
pub type R = crate::R<u32, super::SDIN>;
#[doc = "Writer for register SDIN"]
pub type W = crate::W<u32, super::SDIN>;
#[doc = "Register SDIN `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::SDIN {
    type Type = u32;
    #[inline(always)]
