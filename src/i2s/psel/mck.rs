#[doc = "Reader of register MCK"]
pub type R = crate::R<u32, super::MCK>;
#[doc = "Writer for register MCK"]
pub type W = crate::W<u32, super::MCK>;
#[doc = "Register MCK `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::MCK {
    type Type = u32;
    #[inline(always)]
