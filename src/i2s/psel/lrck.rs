#[doc = "Reader of register LRCK"]
pub type R = crate::R<u32, super::LRCK>;
#[doc = "Writer for register LRCK"]
pub type W = crate::W<u32, super::LRCK>;
#[doc = "Register LRCK `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::LRCK {
    type Type = u32;
    #[inline(always)]
