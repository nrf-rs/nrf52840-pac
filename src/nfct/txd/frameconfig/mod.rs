...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CRCMODETXR {# [ doc = "CRC is not added to the frame" ] NOCRCTX , # [ doc = "16 bit CRC added to the frame based on all the data read from RAM that is used in the frame" ] CRC16TX ,}
impl CRCMODETXR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
pub enum CRCMODETXW {# [ doc = "CRC is not added to the frame" ] NOCRCTX , # [ doc = "16 bit CRC added to the frame based on all the data read from RAM that is used in the frame" ] CRC16TX ,}
impl CRCMODETXW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _CRCMODETXW<'a> {
    ...
    # [ doc = "16 bit CRC added to the frame based on all the data read from RAM that is used in the frame" ] # [ inline ]
