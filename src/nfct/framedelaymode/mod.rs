...
pub enum FRAMEDELAYMODER {# [ doc = "Transmission is independent of frame timer and will start when the STARTTX task is triggered. No timeout." ] FREERUN , # [ doc = "Frame is transmitted between FRAMEDELAYMIN and FRAMEDELAYMAX" ] WINDOW , # [ doc = "Frame is transmitted exactly at FRAMEDELAYMAX" ] EXACTVAL , # [ doc = "Frame is transmitted on a bit grid between FRAMEDELAYMIN and FRAMEDELAYMAX" ] WINDOWGRID ,}
...
pub enum FRAMEDELAYMODEW {# [ doc = "Transmission is independent of frame timer and will start when the STARTTX task is triggered. No timeout." ] FREERUN , # [ doc = "Frame is transmitted between FRAMEDELAYMIN and FRAMEDELAYMAX" ] WINDOW , # [ doc = "Frame is transmitted exactly at FRAMEDELAYMAX" ] EXACTVAL , # [ doc = "Frame is transmitted on a bit grid between FRAMEDELAYMIN and FRAMEDELAYMAX" ] WINDOWGRID ,}
...
impl<'a> _FRAMEDELAYMODEW<'a> {
    ...
    # [ doc = "Transmission is independent of frame timer and will start when the STARTTX task is triggered. No timeout." ] # [ inline ]
