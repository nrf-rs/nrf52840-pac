...
#[repr(C)]
pub struct ACL {
    #[doc = "0x00 - Description cluster[0]: Configure the word-aligned start address of region 0 to protect"]
    pub addr: self::acl::ADDR,
    #[doc = "0x04 - Description cluster[0]: Size of region to protect counting from address ACL[0].ADDR. Write '0' as no effect."]
    pub size: self::acl::SIZE,
    #[doc = "0x08 - Description cluster[0]: Access permissions for region 0 as defined by start address ACL[0].ADDR and size ACL[0].SIZE"]
