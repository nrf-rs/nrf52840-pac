...
pub enum OPERATIONR {# [ doc = "Sample and store one pair (Left + Right) of 16bit samples per RAM word R=[31:16]; L=[15:0]" ] STEREO , # [ doc = "Sample and store two successive Left samples (16 bit each) per RAM word L1=[31:16]; L0=[15:0]" ] MONO ,}
impl OPERATIONR {
...
pub enum OPERATIONW {# [ doc = "Sample and store one pair (Left + Right) of 16bit samples per RAM word R=[31:16]; L=[15:0]" ] STEREO , # [ doc = "Sample and store two successive Left samples (16 bit each) per RAM word L1=[31:16]; L0=[15:0]" ] MONO ,}
impl OPERATIONW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _OPERATIONW<'a> {
    ...
    # [ doc = "Sample and store one pair (Left + Right) of 16bit samples per RAM word R=[31:16]; L=[15:0]" ] # [ inline ]
    pub fn stereo(self) -> &'a mut W {
        self.variant(OPERATIONW::STEREO)
    }
    # [ doc = "Sample and store two successive Left samples (16 bit each) per RAM word L1=[31:16]; L0=[15:0]" ] # [ inline ]
