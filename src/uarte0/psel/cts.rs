#[doc = "Reader of register CTS"]
pub type R = crate::R<u32, super::CTS>;
#[doc = "Writer for register CTS"]
pub type W = crate::W<u32, super::CTS>;
#[doc = "Register CTS `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::CTS {
    type Type = u32;
    #[inline(always)]
